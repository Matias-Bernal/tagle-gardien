...
public class MediadorReclamante {
	...
	public void altaReclamante(String nombre_apellido, String email, String dni, String telefono) {
		guiAltaReclamante = new GUIAltaReclamante(this, nombre_apellido, email, dni, telefono);
		guiAltaReclamante.setVisible(true);
