...
public class GUIAltaReclamoAgente extends JFrame {
	...
	private void initialize() {
		...
		lblDescripcion.setBounds(0, 169, 133, 20);
		...
		btn_buscar_reclamante.setBounds(334, 68, 91, 20);
		...
		button_1.setBounds(80, 262, 110, 20);
		...
		button_2.setBounds(237, 262, 110, 20);
		...
		tP_Descripcion.setBounds(141, 167, 284, 72);
		...
		btn_buscar_Vehivulo.setBounds(334, 94, 91, 20);
		...
		btn_agente.setBounds(334, 42, 91, 20);
		...
		btnOrden.setBounds(334, 121, 91, 20);
