...
public class GUIModificarPedidoAgente extends JFrame{
	...
	public GUIModificarPedidoAgente(final MediadorPedido medidador, String nombre_reclamante, String email, String telefono) {
	 ...
	 */
	public GUIModificarPedidoAgente(final MediadorPedido medidador) {
		this.medidador = medidador;		
		initialize();
		SetVisible(true);
	}
